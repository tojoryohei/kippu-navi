...
export function calculateFareFromPath(fullPath: PathStep[]): number {
    ...
    // （2）東日本旅客鉄道会社線の乗車区間に対する普通旅客運賃の加算額
    if (0 < routeSegmentsByCompany[2].length) {
        fare += calculateFare2(routeSegmentsByCompany[2]) - calculateFare(routeSegmentsByCompany[2]);
    }

    // （3）四国旅客鉄道会社線の乗車区間に対する普通旅客運賃の加算額
    if (0 < routeSegmentsByCompany[5].length) {
        fare += calculateFare5(routeSegmentsByCompany[5]) - calculateFare(routeSegmentsByCompany[5]);
    }

    // （4）九州旅客鉄道会社線の乗車区間に対する普通旅客運賃の加算額
...
function calculateFare2(routeSegments: RouteSegment[]): number {
    ...
    if (isAllKansen(routeSegments)) {
        ...
        if (totalEigyoKilo <= 6) return 200;
        if (totalEigyoKilo <= 10) return 210;
    }
    ...
    if (isAllKansen(routeSegments)) {
        ...
        if (341 <= totalEigyoKilo && totalEigyoKilo <= 360) return 6270;
        if (461 <= totalEigyoKilo && totalEigyoKilo <= 480) return 8030;
        if (841 <= totalEigyoKilo && totalEigyoKilo <= 880) return 11990;
        if (1521 <= totalEigyoKilo && totalEigyoKilo <= 1560) return 17270;
        if (1961 <= totalEigyoKilo && totalEigyoKilo <= 2000) return 20680;
        if (2401 <= totalEigyoKilo && totalEigyoKilo <= 2440) return 24090;
        if (2841 <= totalEigyoKilo && totalEigyoKilo <= 2880) return 27500;
        if (3521 <= totalEigyoKilo && totalEigyoKilo <= 3560) return 32780;
        if (3961 <= totalEigyoKilo && totalEigyoKilo <= 4000) return 36190;
        if (4401 <= totalEigyoKilo && totalEigyoKilo <= 4440) return 39600;
        if (4841 <= totalEigyoKilo && totalEigyoKilo <= 4880) return 43010;

        const splitKilo = calculateSplitKiloOfKansen(totalEigyoKilo);
        if (totalEigyoKilo <= 100) return ceil1000(ceil1000(1696 * splitKilo) * 11 / 10) / 100;
        if (totalEigyoKilo <= 300) return ceil1000(round10000(1696 * splitKilo) * 11 / 10) / 100;
        if (totalEigyoKilo <= 600) return ceil1000(round10000(1696 * 300 + 1345 * (splitKilo - 300)) * 11 / 10) / 100;
    ...
    if (isAllLocal(routeSegments)) {
        ...
        if (24 <= totalEigyoKilo && totalEigyoKilo <= 28) return 530;
        if (33 <= totalEigyoKilo && totalEigyoKilo <= 37) return 720;
        if (42 <= totalEigyoKilo && totalEigyoKilo <= 46) return 910;
        if (47 <= totalEigyoKilo && totalEigyoKilo <= 55) return 1040;
        if (56 <= totalEigyoKilo && totalEigyoKilo <= 64) return 1230;
        if (65 <= totalEigyoKilo && totalEigyoKilo <= 73) return 1410;
        if (74 <= totalEigyoKilo && totalEigyoKilo <= 82) return 1600;
        if (83 <= totalEigyoKilo && totalEigyoKilo <= 91) return 1790;
        if (101 <= totalEigyoKilo && totalEigyoKilo <= 110) return 2090;
        if (129 <= totalEigyoKilo && totalEigyoKilo <= 146) return 2750;
        if (183 <= totalEigyoKilo && totalEigyoKilo <= 200) return 3850;
        if (201 <= totalEigyoKilo && totalEigyoKilo <= 219) return 4180;
        if (220 <= totalEigyoKilo && totalEigyoKilo <= 237) return 4620;
        if (292 <= totalEigyoKilo && totalEigyoKilo <= 310) return 5940;
        if (311 <= totalEigyoKilo && totalEigyoKilo <= 328) return 6270;
        if (420 <= totalEigyoKilo && totalEigyoKilo <= 437) return 8030;
        if (438 <= totalEigyoKilo && totalEigyoKilo <= 455) return 8360;
        if (547 <= totalEigyoKilo && totalEigyoKilo <= 582) return 10120;
        if (583 <= totalEigyoKilo && totalEigyoKilo <= 619) return 10450;
        if (729 <= totalEigyoKilo && totalEigyoKilo <= 764) return 11660;
        if (765 <= totalEigyoKilo && totalEigyoKilo <= 800) return 11990;
        if (947 <= totalEigyoKilo && totalEigyoKilo <= 982) return 13530;
        if (1129 <= totalEigyoKilo && totalEigyoKilo <= 1164) return 15070;

        const splitKilo = calculateSplitKiloOfLocal(totalEigyoKilo);
        if (totalEigyoKilo <= 100) return ceil1000(ceil1000(1866 * splitKilo) * 11 / 10) / 100;
        if (totalEigyoKilo <= 273) return ceil1000(round10000(1866 * splitKilo) * 11 / 10) / 100;
        if (totalEigyoKilo <= 546) return ceil1000(round10000(1866 * 273 + 1480 * (splitKilo - 273)) * 11 / 10) / 100;
    ...
    if (totalGiseiKilo <= 600) return ceil1000(round10000(1696 * 300 + 1345 * (splitKilo - 300)) * 11 / 10) / 100;
    return ceil1000(round10000(1696 * 300 + 1345 * 300 + 705 * (splitKilo - 600)) * 11 / 10) / 100;
}
