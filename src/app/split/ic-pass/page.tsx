...
import FormWithSearchParams from "@/app/split/components/FormWithSearchParams";
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/split/ic-pass",
  },
};


export default function SplitIcPassPage() {
  const jsonLd = {
    '@context': 'https://schema.org',
    '@type': 'WebApplication',
    name: 'JR分割IC定期券計算機',
    description: 'Kitaca・Suica・ICOCAエリアのIC定期券を分割購入した場合の最安パターンを自動計算します。',
    url: 'https://kippu-navi.com/split/ic-pass',
        ...
        <main className="max-w-xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-sm sm:text-base text-slate-600 min-h-20">
              ...
              {"Kitaca・Suica・ICOCAエリアにおいて最安となる分割パターンを自動で導出します。"}
            </p>
          </div>
