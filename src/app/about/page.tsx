                ...
                <section>
                    ...
                    <div className="text-slate-700 leading-relaxed space-y-4">
                        ...
                        <p>
                            ...
                            厳密な最安運賃の算出を目指していますが、必ずしも正確な出力を保証するものではありません。
                    ...
                    <div className="text-slate-800 leading-relaxed">
                        <ul className="list-disc list-outside pl-5 space-y-4">
                            <li className="font-medium">
                                ...
                                <strong className="text-red-600 underline">必ずご自身の責任で購入および利用をしてください。</strong>
                            </li>
                            <li className="font-medium">
                                ...
                                <strong className="text-red-600 underline">当サイトの運営者は一切の責任を負いません。</strong>
                            </li>
                        </ul>
                    </div>
                </section>
