                ...
                <section id="faq" className="scroll-mt-20">
                    ...
                    <div className="space-y-4">
                        ...
                        <FaqItem question="発駅が無人駅で乗車券を持たないまま乗車した場合はどうすればいいですか？">
                            <p>
                                {"基本的に分割乗車券は諦めてください。"}
                                {"乗車券を持たないまま分割駅を通り過ぎ、車内や着駅において分割乗車券が発売されることはありません。"}
                            </p>
                        </FaqItem>

                        <FaqItem question="発駅で分割乗車券の1枚目の乗車券だけ購入した場合は安くなりますか？">
                            <p>
                                {"多くの場合は、差額精算となるため安くならないです。"}
                            ...
                            <div className="mt-4 p-3 bg-white border border-slate-200 rounded-lg space-y-1">
                                ...
                                <p>
                                    ...
                                    {"東京→蒲田の乗車券を使って横浜駅で精算をしても、東京駅からの差額精算となり530円－260円＝270円を支払うことになりやすく移動ができません。"}
