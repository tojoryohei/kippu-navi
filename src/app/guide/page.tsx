            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 sm:p-10 space-y-12">
                ...
                <section id="faq" className="scroll-mt-20">
                    ...
                    <div className="space-y-4">
                        ...
                        <FaqItem question="SuicaなどのICカードを使って分割乗車できますか？">
                            <p>
                                {"分割駅で下車をして、自動改札機で「出場」と「入場」をする必要があります。"}
                                {"なお、当サイトではIC運賃は考慮されていません。"}
                            </p>
                        </FaqItem>

                        <FaqItem question="発駅が無人駅で乗車券を持たないまま乗車した場合はどうすればいいですか？">
                            <p>
                                {"原則として無人駅からの分割乗車券の利用はできませんのでご注意ください。"}
                                {"乗車券を持たないまま分割駅を通り過ぎ、車内や着駅において分割乗車券を購入・精算することはできません。"}
                            </p>
                        </FaqItem>

                        <FaqItem question="発駅で分割乗車券の1枚目だけを購入した場合は安くなりますか？">
                            <p>
                                {"多くの場合は、差額精算となるため安くなりません。"}
                                {"変更区間に対する運賃の収受となる場合は安くなります。"}
                                {"詳しくは"}
                            ...
                            <div className="mt-4 p-3 bg-white border border-slate-200 rounded-lg space-y-1">
                                ...
                                <p>
                                    ...
                                    {"なぜならば、発売駅が発着駅とならない乗車券は、不正乗車防止の観点から自動券売機で発売制限が掛けられているからです。"}
                                    {"東京→蒲田の乗車券を使って横浜駅で精算をしても、東京駅からの差額精算となり530円－260円＝270円を支払うことになり安く移動することはできません。"}
                                    {"そのため、今回の例ではえきねっとで分割乗車券の購入または蒲田駅で一度改札を出る必要があります。"}
                                </p>
                            </div>
                        </FaqItem>
