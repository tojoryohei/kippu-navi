    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <Element name="about">
        ...
        <p className="mb-4">
          ...
          <br />
          【予定】※サーバーの計算処理時間の制約上、分割乗車券の自動探索機能は「直線距離120km以内」の中距離区間に限定して提供しております．
          <br />
          <br />
          また，このサイトの情報や計算結果をもとにきっぷを購入するときは，必ずJRの旅客営業規則等を確認してからご自身の責任においてお買い求めください．
          <br />
          <br />
          ※「なぜ乗車券を分割すると安くなるのか」という仕組みや，当サイトが採用している経路探索アルゴリズム（卒業研究論文）に関する詳細な解説は，
          <NextLink href="/about" className="text-blue-600 hover:underline">
            「仕組み」のページ
          </NextLink>
          をご覧ください．
        </p>
