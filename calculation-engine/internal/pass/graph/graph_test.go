...
func TestFindShortestPathGisei(t *testing.T) {
	...
	// A --(10.0km)--> B --(20.0km)--> C
	// A --(40.0km)----------------> C
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: startID, ToID: midID, GiseiKilo: 100, EigyoKilo: 100}})
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: midID, ToID: endID, GiseiKilo: 200, EigyoKilo: 200}})
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: startID, ToID: endID, GiseiKilo: 400, EigyoKilo: 400}})
...
func TestFindKShortestPathsGisei(t *testing.T) {
	...
	// A <--(15)--> C <--(10)--> D
	// A <--(45)--------------> D
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: startID, ToID: bID, GiseiKilo: 100, EigyoKilo: 100}})
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: bID, ToID: startID, GiseiKilo: 100, EigyoKilo: 100}})
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: bID, ToID: endID, GiseiKilo: 200, EigyoKilo: 200}})
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: endID, ToID: bID, GiseiKilo: 200, EigyoKilo: 200}})
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: startID, ToID: cID, GiseiKilo: 150, EigyoKilo: 150}})
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: cID, ToID: startID, GiseiKilo: 150, EigyoKilo: 150}})
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: cID, ToID: endID, GiseiKilo: 100, EigyoKilo: 100}})
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: endID, ToID: cID, GiseiKilo: 100, EigyoKilo: 100}})
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: startID, ToID: endID, GiseiKilo: 450, EigyoKilo: 450}})
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: endID, ToID: startID, GiseiKilo: 450, EigyoKilo: 450}})
