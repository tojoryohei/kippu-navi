...
func TestGetVia_Unit(t *testing.T) {
	...
	// シンプルなグラフを作成
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: id("A"), ToID: id("B")}})
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: id("B"), ToID: id("A")}})
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: id("B"), ToID: id("C")}})
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: id("C"), ToID: id("B")}})
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: id("C"), ToID: id("D")}})
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: id("D"), ToID: id("C")}})
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: id("B"), ToID: id("E")}})
	g.AddEdge(passdomain.PassEdge{Edge: domain.Edge{FromID: id("E"), ToID: id("B")}})
