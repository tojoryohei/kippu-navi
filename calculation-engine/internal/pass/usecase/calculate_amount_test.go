...
func TestCalculateAmount_Execute(t *testing.T) {
	...
	for i := range dummyTable {
		dummyTable[i] = passdomain.PassPrice{OneMonth: i * 100}
	}
	...
	// 加算運賃：B-C間に100円加算
	addonFareReg.Register("B", "C", passdomain.PassPrice{OneMonth: 100, ThreeMonth: 300, SixMonth: 600})
	...
	// 特急料金：B-C間に100円加算
	addonChargeReg.Register("B", "C", passdomain.PassPrice{OneMonth: 100, ThreeMonth: 300, SixMonth: 600})
