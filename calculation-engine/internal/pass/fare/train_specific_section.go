...
func NewTrainSpecificSectionCalculator(fares [101]passdomain.PassPrice) *TrainSpecificSectionCalculator {
	return &TrainSpecificSectionCalculator{fares: fares}
}

// Calculate は電車特定区間の運賃を計算します。
func (c *TrainSpecificSectionCalculator) Calculate(params passdomain.PassFareParams) (int, error) {
