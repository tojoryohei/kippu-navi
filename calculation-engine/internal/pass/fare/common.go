...
func calculateBaseFare(params passdomain.PassFareParams, trunkTable, localTable *[101]passdomain.PassPrice) (int, error) {
	var targetKm int
...
func calculateSingleTableFare(params passdomain.PassFareParams, table *[101]passdomain.PassPrice) (int, error) {
	targetKm, err := params.GiseiKilo.ToCeiledKm()
	if err != nil {
...
func calculateFromTable(targetKm int, months int, table *[101]passdomain.PassPrice) (int, error) {
	if table == nil {
