...
func (m *PathMatcher) LoadFromDomainWithOptions(pathAndFares []ticketdomain.PathAndFare, g graph.Graph, ignoreMissing bool) error {
	if g == nil {
...
func (m *PathMatcher) LoadFromDomain(pathAndFares []ticketdomain.PathAndFare, g graph.Graph) error {
