...
func (m *PathMatcher) LoadFromDomainWithOptions(path_and_fares []ticketdomain.PathAndFare, g graph.Graph, ignoreMissing bool) error {
	if g == nil {
...
func (m *PathMatcher) LoadFromDomain(path_and_fares []ticketdomain.PathAndFare, g graph.Graph) error {
...
func (m *PathMatcher) Insert(path []int, fare int) error {
	// 重複チェック
...
func (m *PathMatcher) Search(path []int) (int, bool) {
	if m.table == nil {
		return 0, false
	}
