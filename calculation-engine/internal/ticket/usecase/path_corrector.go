	...
	return &SpecificSectionCorrector{
		rules: []struct {
			...
			},
			{
				...
				from:        []string{"東京", "八丁堀", "越中島", "潮見", "新木場", "葛西臨海公園", "舞浜", "新浦安", "市川塩浜", "二俣新町", "南船橋", "新習志野", "幕張豊砂", "海浜幕張", "検見川浜", "稲毛海岸", "千葉みなと", "蘇我"},
				to:          []string{"東京", "新日本橋", "馬喰町", "錦糸町", "亀戸", "平井", "新小岩", "小岩", "市川", "本八幡", "下総中山", "西船橋", "船橋", "東船橋", "津田沼", "幕張本郷", "幕張", "新検見川", "稲毛", "西千葉", "千葉", "本千葉", "蘇我"},
				validBefore: []string{"品川", "有楽町", "神田"},
				validAfter:  []string{"蘇我", "鎌取", "浜野"},
			},
			{
